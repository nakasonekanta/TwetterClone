        ...
        <div class="main">
            ...
            <div class="profile-area">
                                ...
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb">
                                            ...
                                            <input type="file" class="form-control from-control-sm" name="image">
                                        </div>
                                        <input type="text" class="form-control mb-4" name="nickname" value="太郎" placeholder="ニックネーム" maxlength="50" required>
                                        <input type="text" class="form-control mb4" name="name"  value="taro" placeholder="ユーザー名" maxlength="50" required>
                                        <input type="email" class="form-control mb4" name="email" value="taro@techis.jp"  placeholder="メールアドレス" maxlength="254" required>
                                        <input type="password" class="form-control mb4" name="password"  value="" placeholder="パスワードを変更する場合誤入力ください" minlength="4" maxlength="128">
                                    </div>
                                    
                                    <div class="modal-footer">
                                        <button class="btn bt-reverse" data-bs-dismiss="modal">キャンセル</button>
                ...
                <div class="follow-follower">
                    ...
                    <div class="follow-text">フォロ中</div>
                    <div class="follow-count">1</div>
